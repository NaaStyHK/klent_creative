...
type ProjectsDict = {
  ...
  comingSoonLabel: string; viewProjectLabel: string;
};
                      ...
                      <div className="sl-overlay">
                        <div className="sl-overlay-top">
                          ...
                          <div className="sl-overlay-top-right">
                            ...
                            {!isComingSoon && (
                              <a href={project.href || "#contact"} target={project.href ? "_blank" : undefined} rel={project.href ? "noopener noreferrer" : undefined} className="sl-cta" aria-label={dict.viewProjectLabel}>
