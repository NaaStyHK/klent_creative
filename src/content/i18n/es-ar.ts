...
export const esAr: Dictionary = {
  ...
  blog: {
    ...
    metaDescription: "Precios, plazos y criterios de decisión sobre creación web, aplicaciones móviles y branding, explicados sin vueltas por el estudio Klent Creative.",
    eyebrow: "Blog",
    ...
    cta: {
      eyebrow: "¿Y ahora?",
      title: "¿Este tema encaja con algún proyecto? Hablemos. Respondemos en menos de 24 horas.",
      button: "Empezar un proyecto",
  ...
  contact: {
    ...
    metaDescription: "Contactate con KLENT CREATIVE para hablar de tu proyecto de branding, sitio web o app móvil.",
    eyebrow: "Contacto",
    h1: ["Hablemos ", { outline: "de tu proyecto." }],
    intro:
